...
struct EgcdTestCaseStruct {
    std::string testMessage;
    std::vector<mpz_class> bigNumbersVector;
    std::vector<mpz_class> expectedRemaindersVector;
    EgcdTestCaseStruct(std::string tm, std::vector<mpz_class> bnv, std::vector<mpz_class> erv)
        : testMessage(std::move(tm)), bigNumbersVector(std::move(bnv)), expectedRemaindersVector(std::move(erv)) {}
};

std::vector<EgcdTestCaseStruct> egcdTestCases = {
        EgcdTestCaseStruct("Normal test case", {15, 77, 221, 57}, {3, 1, 1, 3}),
        EgcdTestCaseStruct("Case1: Amount isnot equal to 2^k", {15, 77, 221, 57, 667}, {3, 1, 1, 3, 1}),
        EgcdTestCaseStruct("Case2: Amount isnot equal to 2^k", {15, 77, 221, 57, 667, 217}, {3, 7, 1, 3, 1, 7}),
        EgcdTestCaseStruct("Case3: Amount isnot equal to 2^k", {221, 57, 15, 667, 217, 1763, 77,}, {1, 3, 3, 1, 7, 1, 7,}),
        EgcdTestCaseStruct("Numbers contain 0", {0, 57, 15, 667, 217, 1763, 77,}, {1, 3, 3, 1, 7, 1, 7,}),
        EgcdTestCaseStruct("Big number with 1024bits test.", {
